...
$string['wizard_help_sections_desc'] = '"Items & Trade" groups collectibles and what wires them into trades; "Other dynamics" covers missions, RPG and ranking.';
$string['wizard_help_sections_title'] = 'The two sections';
...
$string['wizard_module_autodistribute_desc'] = 'Automatically inserts each generated drop into existing activities.';
$string['wizard_module_avatars'] = 'Avatar pack';
$string['wizard_module_avatars_desc'] = 'Creates a ready-to-use set of profile avatars students can equip.';
$string['wizard_module_generated'] = 'Already generated in this course';
$string['wizard_module_items_ai'] = 'Generate items';
$string['wizard_module_items_desc'] = 'Generates collectable items, ready to distribute as drops.';
$string['wizard_module_latepenalty'] = 'Deadline Extension (latepenalty)';
$string['wizard_module_latepenalty_desc'] = 'Creates the Deadline Extension item, purchasable with PlayerCoin and awarded by an early quest.';
$string['wizard_module_missions'] = 'Missions';
$string['wizard_module_missions_desc'] = 'Suggests level, collection and activity-completion milestones, sized to the chosen journey.';
$string['wizard_module_pill'] = 'Knowledge collectible';
$string['wizard_module_pill_desc'] = 'Creates a limited collectible spread across course activities and a prize book earned by trading them all in.';
$string['wizard_module_playercoin'] = 'PlayerCoin';
$string['wizard_module_playercoin_desc'] = 'Creates the tradable PlayerCoin currency item and auto-distributes it in the course news forum.';
$string['wizard_module_progress_item'] = 'RPG item';
$string['wizard_module_progress_item_desc'] = 'Creates a collectible with an infinite drop that the RPG mode can use as a cost to advance.';
$string['wizard_module_ranking'] = 'Ranking & Competition';
$string['wizard_module_ranking_desc'] = "Turns on the block's ranking and leaderboard, if not already on.";
$string['wizard_module_rpg'] = 'RPG: Characters & Full Story';
$string['wizard_module_rpg_desc'] = 'Creates 3 character classes and generates the full story arc with AI (opening chapter to the end, always complete), chapter count sized to the chosen journey and coherent from beginning to end. Creates the progress item first if it does not exist yet, and some choices will cost it to advance.';
$string['wizard_module_secret'] = 'Secret Drops';
$string['wizard_module_secret_desc'] = 'Creates a rare, hidden collectible scattered through a few course activities — its identity stays a mystery ("???") until a student finds it.';
$string['wizard_module_trade'] = 'Trade';
$string['wizard_module_trade_desc'] = 'Wires PlayerCoin and Avatar Pack together into ready-to-use trades, based on what already exists in this instance.';
...
$string['wizard_section_items_trade'] = 'Items & Trade';
$string['wizard_section_other'] = 'Other dynamics';
