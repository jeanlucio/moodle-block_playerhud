...
$string['wizard_card_toggle_label'] = 'Show or hide details';
...
$string['wizard_group_items_desc'] = 'Collectible items: AI-generated, currency, avatars, knowledge collectible, deadline extension.';
...
$string['wizard_levels_apply_btn'] = 'Apply suggestion';
$string['wizard_levels_suggestion_long'] = 'Suggestion for a Long journey: 20 levels × 100 XP each.';
$string['wizard_levels_suggestion_medium'] = 'Suggestion for a Medium journey: 15 levels × 100 XP each.';
$string['wizard_levels_suggestion_short'] = 'Suggestion for a Short journey: 10 levels × 100 XP each.';
...
$string['wizard_module_autodistribute'] = 'Auto-distribute drops';
$string['wizard_module_autodistribute_desc'] = 'If the course already has activities, automatically inserts each generated drop into the best-matching one.';
...
$string['wizard_module_items'] = 'Items';
$string['wizard_module_items_ai'] = 'Generate items (AI)';
$string['wizard_module_items_desc'] = 'Generates collectable items with AI, ready to distribute as drops.';
...
$string['wizard_module_next_chapter'] = 'Story arc (AI)';
$string['wizard_module_next_chapter_desc'] = 'Generates the rest of the story arc with AI, chapter count sized to the chosen journey, kept coherent from beginning to end. Creates the progress item first if it does not exist yet, and some choices will cost it to advance.';
...
$string['wizard_module_progress_item'] = 'Progress item';
$string['wizard_module_progress_item_desc'] = 'Creates a themed collectible (infinite drop) that future story chapters can use as a cost to advance.';
...
$string['wizard_module_rpg'] = 'RPG: Characters & Chapter 1';
$string['wizard_module_rpg_desc'] = 'Creates 3 character classes and the opening story chapter where students choose one.';
...
$string['wizard_modules_label'] = 'Mechanics to generate';
$string['wizard_more_modules_soon'] = 'More mechanics are coming in a future update.';
