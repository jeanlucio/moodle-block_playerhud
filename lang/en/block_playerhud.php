...
$string['item_delete_confirm_trades'] = 'Delete item and {$a} trade(s)';
$string['item_delete_trade_impact'] = 'This item is used in the following trade(s). Deleting it will permanently remove them as well. To keep these trades, cancel and edit each trade to remove this item first.';
