...
$string['wizard_huddy_tip1'] = 'Tip: XP and levels reward steady progress — that is the Octalysis "Achievement" drive.';
$string['wizard_huddy_tip2'] = 'Tip: Secret Drops turn discovery into a moment of surprise — that is the "Unpredictability" drive.';
$string['wizard_huddy_tip3'] = 'Tip: Ranking can be turned off any time from the block\'s own settings, without undoing a run.';
$string['wizard_huddy_tip4'] = 'Tip: every run can be undone with one click from the History list, even after closing this modal.';
