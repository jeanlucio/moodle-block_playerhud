...
$string['wizard_module_missions_desc'] = 'Suggests level and collection milestones based on the items already in this instance.';
...
$string['wizard_pill_quest_name'] = 'Collect: {$a}';
