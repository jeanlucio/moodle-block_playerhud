...
$string['help_teacher_section_story'] = 'The Story module lets you create interactive narratives with choices and karma effects. Create chapters in the Chapters tab. Each chapter contains nodes (story moments) and choices (transitions between nodes). Choices can grant or deduct karma, consume items from the student\'s inventory, and be gated by character, karma range, or item possession. Build branching storylines in the chapter editor.';
