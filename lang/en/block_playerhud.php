...
$string['wizard_module_next_chapter'] = 'Next chapter (AI)';
$string['wizard_module_next_chapter_desc'] = 'Generates a new story chapter with AI. Creates the progress item first if it does not exist yet, and some choices will cost it to advance.';
...
$string['wizard_octalysis_warning1'] = 'No Achievement — students see no tangible progress.';
$string['wizard_octalysis_warning2'] = 'No Creativity — no room for personal expression.';
$string['wizard_octalysis_warning3'] = 'No Empowerment — students make no meaningful decisions.';
$string['wizard_octalysis_warning4'] = 'No Social Influence — the experience is purely individual.';
$string['wizard_octalysis_warning5'] = 'No Scarcity — nothing feels rare or special.';
$string['wizard_octalysis_warning6'] = 'No Unpredictability — the journey becomes predictable.';
$string['wizard_octalysis_warning7'] = 'No Meaning — missing narrative and a greater purpose.';
$string['wizard_octalysis_warning8'] = 'No Ownership — students build no identity in the game.';
