...
$string['wizard_help_once_desc'] = 'Each mechanic can only be generated once per course — once done, its card disables with a green checkmark. To add more later, use the dedicated screens: Create Magic Item, Suggest Missions, Suggest Trades and Distribute Drops.';
