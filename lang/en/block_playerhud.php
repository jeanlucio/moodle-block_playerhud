...
$string['ai_prompt_class_oracle'] = 'You are an RPG game designer for an educational game. Create a unique character based on the theme: {$a}. Reply ONLY with valid JSON — no markdown, no extra text. Structure: {"name":"character name (max 4 words)","description":"flavour text (max 150 characters)","hp":120}';
