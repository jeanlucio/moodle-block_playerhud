...
$string['ai_oracle_btn'] = 'Class Oracle';
$string['ai_oracle_modal_title'] = 'Class Oracle';
$string['ai_oracle_success'] = 'Class \'{$a}\' created and saved.';
...
$string['restrict_class'] = 'Class restriction';
$string['restrict_class_help'] = 'Select which classes can collect this item. Leave empty to allow all classes.';
