...
$string['item_delete_confirm_trades'] = 'Excluir item e {$a} troca(s)';
$string['item_delete_trade_impact'] = 'Este item é usado nas seguintes troca(s). Excluí-lo removerá permanentemente essas trocas também. Para mantê-las, cancele e edite cada troca para remover este item primeiro.';
