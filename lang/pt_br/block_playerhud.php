...
$string['ai_prompt_class_oracle'] = 'Você é um designer de RPG para um jogo educacional. Crie uma classe de personagem única com base no tema: {$a}. Responda APENAS com JSON válido — sem markdown, sem texto extra. Estrutura: {"name":"nome da classe (máx. 4 palavras)","description":"texto de ambientação (máx. 150 caracteres)","hp":120}';
...
$string['enable_rpg_mode_help'] = 'Quando ativado, os estudantes podem escolher uma classe de personagem, acompanhar a história, acumular reputação e ver o retrato em evolução. Quando desativado, todos esses recursos ficam ocultos para estudantes e professores neste curso.';
