...
$string['dropcode_help'] = 'Copie este código e cole em qualquer lugar do seu curso (Rótulos, Páginas, Fóruns, Tarefas, etc). Quando o aluno vir este código, o botão "Coletar" aparecerá.';
...
$string['gen_copied'] = 'Código copiado!';
...
$string['leaderboard_title'] = 'Placar de Líderes';
$string['level'] = 'Nível';
...
$string['tab_classes'] = 'Personagens & Classes';
$string['tab_collection'] = 'Coleção';
$string['tab_config'] = 'Gerente & APIs';
...
$string['tab_quests'] = 'Missões & Conquistas';
$string['tab_reports'] = 'Relatórios';
$string['tab_shop'] = 'Loja (NPC)';
$string['tab_trades'] = 'Troca (NPC)';
$string['take'] = 'Pegar';
$string['test'] = 'Testar';
...
$string['widget_code_desc'] = 'Para exibir a <strong>Barra de XP, Nível e atalho da Mochila</strong>, copie o código abaixo e cole em um <strong>Rótulo</strong> no topo do seu curso (Tópico Zero).';
$string['widget_code_tip'] = 'Se você colar este código em um "Bloco HTML" na lateral do curso, o HUD seguirá o aluno durante a navegação!';
$string['widget_code_title'] = 'Código do Painel Principal (Widget)';
$string['xp'] = 'XP';
...
$string['drops_summary'] = 'Você possui {$a} drops espalhados para este item. Dica: Se você colocar o nome da atividade na localização, o sistema gera automaticamente o link para que você possa acessá-la rapidamente.';
