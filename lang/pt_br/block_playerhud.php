...
$string['api_settings_desc'] = 'Se você tiver suas próprias chaves de API (Gemini ou Groq), insira-as aqui. Elas agora são salvas com segurança nas suas preferências de usuário. O sistema usará suas chaves como prioridade. Se deixar em branco, o sistema tentará usar a chave global da instituição (se houver).';
...
$string['choice_class_label'] = 'Atribuir Classe';
...
$string['class_delete_confirm'] = 'Deletar esta classe? Os alunos que a selecionaram terão sua classe redefinida.';
...
$string['class_select_btn'] = 'Escolher Esta Classe';
$string['class_select_intro'] = 'Selecione a classe que melhor representa seu estilo. Essa escolha define o avatar e a evolução visual do seu personagem ao longo do curso.';
$string['class_select_title'] = 'Escolha Sua Classe';
$string['class_selected_badge'] = 'Selecionada';
$string['class_selected_success'] = 'Classe selecionada com sucesso!';
...
$string['low_karma'] = 'Você não tem karma suficiente para esta escolha.';
...
$string['new_class'] = 'Sua classe foi alterada para {$a}.';
...
$string['quest_class_locked'] = 'Requer uma classe RPG específica.';
...
$string['quest_requirement_help'] = 'Descreva claramente o que o aluno precisa fazer para resgatar esta recompensa.';
...
$string['quest_type_manual'] = 'Manual (Aluno Resgata)';
...
$string['quests_summary_hint'] = 'Quando o aluno cumpre o objetivo, a recompensa (XP e/ou item) é concedida na hora e pode ser resgatada na área de Missões do aluno. Use o botão "Sugerir Missões" para criar novas missões automaticamente.';
...
$string['read_again'] = 'Ler novamente';
$string['ready'] = 'Pronto!';
...
$string['tab_classes'] = 'Classes & Personagens';
...
$string['trades_summary_hint'] = 'As ofertas de troca definem as regras de negociação com o NPC: o aluno paga um ou mais itens e recebe outro em troca. Use "Loja" para exibir a oferta na aba da loja, ou incorpore-a em qualquer parte do curso usando o shortcode exibido.';
