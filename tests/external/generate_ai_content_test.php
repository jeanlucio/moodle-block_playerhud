...
final class generate_ai_content_test extends external_base_testcase {
     ...
     */
    public function test_generate_ai_content_message_field_rejects_unclean_html(): void {
        ...
        external_api::clean_returnvalue(generate_ai_content::execute_returns(), $malicious);
    }
