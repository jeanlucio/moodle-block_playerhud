...
Source code: [github.com/jeanlucio/moodle-block_playerhud](https://github.com/jeanlucio/moodle-block_playerhud)
...
<span id="group-ranking"></span>
{% include_relative en/group-ranking.md %}
