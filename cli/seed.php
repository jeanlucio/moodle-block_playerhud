...
/**
 * Generates a simple colour+initial PNG avatar and sets it as the user's profile picture, via
 * the same process_new_icon() API Moodle's own profile picture upload uses.
 *
 * Purely cosmetic: without this, every seed account renders as a plain grey initials circle in
 * screenshots, which is harder to tell apart at a glance in the training material.
 *
...
$teacher = seed_create_user(SEED_USER_PREFIX . 'teacher', 'Dungeon', 'Master', SEED_PASSWORD, $existingseedusers);
$students = [];
$studentnames = [
